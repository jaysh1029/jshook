...
HTMLDivElement = function HTMLDivElement() {
	return ldvm.toolsFunc.throwError("TypeError", "Failed to construct 'HTMLDivElement': Illegal constructor");
}
ldvm.toolsFunc.safeProto(HTMLDivElement, "HTMLDivElement");
Object.setPrototypeOf(HTMLDivElement.prototype, HTMLElement.prototype);
ldvm.toolsFunc.defineProperty(HTMLDivElement.prototype,"align",{configurable:true,enumerable:true,get: function () {
        // 分发器
